...
{
    /// <summary>
    /// The DiagnosticBag class represents a collection of diagnostics in the syntax tree.
    /// </summary>
    internal sealed class DiagnosticBag : IEnumerable<Diagnostic>
    {
        ...
        {
            var message = $"ERROR: The number {text} is not valid in Int32";
            Report(span, message);
        }
        ...
        internal void ReportExpressionMustBeBoolean(string v)
        {
